...
def seed_default_activities(db: Session, user_id: str):
    ...
    defaults = [
        {"type": "session_start", "description": "Remote session started by My Phone", "time": "9:41 AM",
         "timestamp": 1721468460000, "device_name": "My Phone", "icon": "play"},
        {"type": "file_transfer", "description": "File transferred — Screenshot.png", "time": "9:35 AM",
         "timestamp": 1721468100000, "file_name": "Screenshot.png", "icon": "file"},
        {"type": "session_end", "description": "Remote session ended by My Phone", "time": "9:20 AM",
         "timestamp": 1721467200000, "device_name": "My Phone", "icon": "stop"},
        {"type": "settings", "description": "Settings changed — Display", "time": "9:10 AM",
         "timestamp": 1721466600000, "detail": "Display", "icon": "settings"},
        {"type": "file_download", "description": "File downloaded — Photo.png", "time": "8:30 AM",
         "timestamp": 1721464200000, "file_name": "Photo.png", "icon": "download"},
        {"type": "device_paired", "description": "Device paired — NOVA Web", "time": "8:15 AM",
         "timestamp": 1721463300000, "device_name": "NOVA Web", "icon": "link"},
        {"type": "system", "description": "System update checked", "time": "7:45 AM",
         "timestamp": 1721461500000, "detail": "No updates available", "icon": "refresh"},
        {"type": "session_start", "description": "Remote session started by NOVA Web", "time": "7:30 AM",
         "timestamp": 1721460600000, "device_name": "NOVA Web", "icon": "play"},
        {"type": "power", "description": "Power action — Sleep mode", "time": "Yesterday",
         "timestamp": 1721376000000, "detail": "Sleep", "icon": "moon"},
        {"type": "file_transfer", "description": "File transferred — Report.pdf", "time": "Yesterday",
